...
<!-- Video text --> 
	<div class="Video_Text"> 
		<h1 style="color:white;">Jeffrey's Portfolio</h1>
			<p> 
				<strong>
					<center>
						...
						<br>
						My name is Jeffrey McDaniel. Welcome to my portfolio website. On it, I will tell you about my background and experience.<br>
...
<!-- GitHub section -->
	<div class="Row" id="GitHub">
		<div class="Column_1"> <!-- Left column -->
			<h1>GitHub</h1>
				<center><p1>You can view my coding projects on my GitHub profile <a href="https://github.com/JeffMcDaniel1" target="_blank">here</a><br></p1></center>
				
		</div>
		
		<div class="Column_2"> <!-- Right column -->
			<a href="https://github.com/JeffMcDaniel1" target="_blank"><img src="./images/GitHub.png" alt="GitHub"></a>
		</div>
	</div>
